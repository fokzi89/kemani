<script lang="ts">
	import { ArrowLeft, ShoppingCart, Package, Star, MessageSquare, CheckCircle2 } from 'lucide-svelte';
	...
	<main class="container py-12">
		{#if products.length === 0}
			<div class="empty-state">
				...
				<p>Check back later for our handpicked recommendations.</p>
...
<style>
	...
	.discount-badge { position: absolute; top: 1rem; left: 1rem; background: #0f172a; color: #fff; font-size: 11px; font-weight: 800; padding: 4px 10px; border-radius: 8px; text-transform: uppercase; }
	...
	.add-btn { background: #0f172a; color: #fff; border: none; }
	.add-btn:hover { background: #4f46e5; transform: scale(1.05); }
