...
type LayoutRouteId = RouteId | "/(marketplace)" | "/(marketplace)/cart" | "/(marketplace)/checkout" | "/(marketplace)/medics" | "/(marketplace)/medics/[medicId]" | "/(marketplace)/products/[productId]" | "/(marketplace)/profile" | "/auth/callback" | "/auth/portal" | "/consultations" | "/diagnostics" | null
