...
<div class="page-wrap">
  ...
  <section class="hero">
    <div class="hero-inner">
      <h1 class="hero-title">Find a Doctor</h1>
      ...
      <div class="search-bar-wrap">
        ...
        <div class="search-field">
          ...
          <input type="text" value="Abuja, Nigeria" placeholder="City, State" class="search-input" />
        </div>
            ...
            <article class="doctor-card">
              ...
              <div class="card-header">
                <div class="card-avatar-wrap">
                  {#if doctor.photo_url}
                    <img src={doctor.photo_url} alt={doctor.display_name} class="card-avatar" />
                  {:else}
              ...
              <!-- Card Body -->
              <div class="card-body">
                <h3 class="card-name">{doctor.display_name}</h3>
                <p class="card-specialty" style="color:{brandColor}">{doctor.specialization || 'General Practitioner'}</p>
                ...
                <div class="card-meta">
                  <span class="meta-item">
                    ...
                    <strong>{(doctor.rating || 4.9).toFixed(1)}</strong>
                    <span class="meta-light">({doctor.reviews || 0})</span>
                  </span>
                  <span class="meta-item">
